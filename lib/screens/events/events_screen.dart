  ...
  Widget build(BuildContext context) {
    return Consumer<AuthViewModel>(
      builder: (context, authViewModel, _) {
        return _EventsContent(authViewModel: authViewModel);
      },
    );
  }
}
...
class _EventsContent extends StatelessWidget {
  ...
  const _EventsContent({required this.authViewModel});
  ...
  Widget build(BuildContext context) {
    ...
    final String userRole =
        authViewModel.currentUser?.role.trim().toLowerCase() ?? '';
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  onChanged: (val) =>
                      setState(() {}), // trigger preview rebuild
                ),
